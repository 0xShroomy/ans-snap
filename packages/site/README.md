...
By default you can use the `GATSBY_SNAP_ORIGIN` variable (used in `src/config/snap.ts`) to define a production origin for your snap (e.g. `npm:MyPackageName`). If not defined it will default to `local:http://localhost:8080`.
