      ...
      <FooterContainer>
        <FooterContent>
          ...
          <FooterColumn>
            ...
            <FooterLink href="https://www.hoodedphantoms.xyz/launchpad">
              Launchpad
            </FooterLink>
            <FooterLink href="https://www.hoodedphantoms.xyz/inventory">
              Inventory
            </FooterLink>
            <FooterLink href="https://www.hoodedphantoms.xyz/domains">
              Domains
            </FooterLink>
            <FooterLink
              href="https://magiceden.io/collections/abstract/0xcc367ea125c60de7a0c6c4636d5f51aa3a68d0df"
              target="_blank"
            >
              Phantom Marketplace
            </FooterLink>
          ...
          <FooterColumn>
            ...
            <FooterLink href="https://twitter.com/HoodedHub" target="_blank">
              Twitter
            </FooterLink>
            <FooterLink
              href="https://hoodedphantoms.xyz/audits"
              target="_blank"
            >
              Audits
            </FooterLink>
            <FooterLink
              href="https://magiceden.io/collections/abstract/0x0ebc94534eda78332e49f3bfa3a2471e52fadfbf"
              target="_blank"
            >
              Domains Marketplace
            </FooterLink>
